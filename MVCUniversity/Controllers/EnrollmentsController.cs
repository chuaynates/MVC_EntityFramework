...
namespace MVCUniversity.Controllers
{
    public class EnrollmentsController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            return View(enrollment.Where(x => x.Enable == true).ToList());
        }
        ...
        {
            ViewBag.CourseID = new SelectList(db.Course.Where(x => x.Enable == true).ToList(), "CourseID", "Title");
            ViewBag.StudentID = new SelectList(db.Student.Where(x => x.Enable == true).ToList(), "StudentID", "LastName");
            return View();
        }
        ...
        public ActionResult Edit(int? id)
        {
            ...
            ViewBag.CourseID = new SelectList(db.Course.Where(x => x.Enable == true).ToList(), "CourseID", "Title", enrollment.CourseID);
            ViewBag.StudentID = new SelectList(db.Student.Where(x => x.Enable == true).ToList(), "StudentID", "LastName", enrollment.StudentID);
            return View(enrollment);
        }
